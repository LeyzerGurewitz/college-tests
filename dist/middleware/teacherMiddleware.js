...
exports.checkTeacherRole = void 0;
const jwtUtils_1 = require("../utils/jwtUtils");
const teacherModel_1 = __importDefault(require("../models/teacherModel"));
const checkTeacherRole = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield teacherModel_1.default.findById(decoded.id);
        if (!user) {
